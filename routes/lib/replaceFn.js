const replaceFn = ({ req, todolist }) => {
  if (!req || !req.body || !req.body.toedit || !req.sanitize) {
    ...
    new Error(
      "Parameter 'req' or is falsy or req does not have a 'body' or 'sanitize' property or there is no 'toedit' property on 'body'. "
    );
    return [];
  }
  ...
  return [
    ...firstSection,
    ...[req.sanitize(req.body.revision)],
    ...secondSection
  ];
};
